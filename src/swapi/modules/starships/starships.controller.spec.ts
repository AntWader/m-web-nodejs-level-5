...
describe('StarshipsController', () => {
  ...
  beforeEach(async () => {
    ...
    }).overrideProvider(StarshipsService).useValue(mockService).compile();
  ...
  describe('create', () => {
    ...
    it('should return created entity', async () => {
      expect(await controller.create(entityDto)).toEqual(expect.objectContaining(expectedStarshipEntity));
    });
  });
  ...
  describe('findOne', () => {
    ...
    it('should return a starship', async () => {
      expect(await controller.findOne(id)).toEqual(expect.objectContaining(expectedStarshipEntity));
    });
